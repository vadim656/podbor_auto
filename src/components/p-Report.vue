...
<template>
  <div class="relative  bg-[#1F1A20]">
    <img class="absolute z-10 right-0 w-[400px] bottom-[100px] " src="../assets/calculator_right.png"  alt="">
    <div class="h-56 bg-[#1F1A20] sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div class="md:ml-auto md:w-1/2 md:pl-10">
        <h2 class="text-base font-semibold uppercase tracking-wider text-gray-300">
         Обьективная проверка
        </h2>
        <p class="mt-2 text-white text-3xl font-extrabold tracking-tight sm:text-4xl">
          Полный отчет об авто
        </p>
        <p class="mt-3 text-lg text-gray-300">
          Направляем видео-/фотоотчет и диагностический
лист (с комментариями эксперта) после каждой
проверки на почту или в мессенджеры.
Прикрепляем все документы к договору.
        </p>
        <div class="mt-8">
